...
// 工具调用类型定义
type ToolType = "market_analysis" | "task_creation" | "contract_interaction" | "research" | "data_visualization" | "task_publishing";
...
export const ChatInterface = () => {
  ...
  const ideaBotConversation: BotMessage[] = [
    { sender: "0xIdeaBot", text: "Hello! I'm IdeaBot. I can help you find suitable tasks based on your skills and market trends, or help you create new tasks.", timestamp: "Just now" },
  ];

  // Mock conversation data - modify to use BotMessage type
  const conversationsData: {[key: string]: BotMessage[]} = {
    "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266": [
      { sender: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", text: "Hi, I saw your AI task solution. Can you provide some details on how you implemented it?", timestamp: "10:32 AM" },
      { sender: "me", text: "Hey Alex! Sure, I used a transformer-based approach with a custom training dataset.", timestamp: "10:35 AM" },
      { sender: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", text: "That's interesting. How did you handle the data preprocessing?", timestamp: "10:38 AM" },
      { sender: "me", text: "I created a pipeline that first cleans the input, removes bias, and then tokenizes everything with BytePair encoding.", timestamp: "10:40 AM" },
      { sender: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", text: "Great job! I'd like to discuss potential collaboration on a similar project.", timestamp: "10:42 AM" },
      { sender: "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266", text: "Thanks for completing the task!", timestamp: "10:45 AM" },
    ],
    "0x70997970C51812dc3A010C7d01b50e0d17dc79C8": [
      { sender: "me", text: "Hi Maria, I've completed the initial research for the DeFi project.", timestamp: "Yesterday" },
      { sender: "0x70997970C51812dc3A010C7d01b50e0d17dc79C8", text: "Thanks for the update. Can you provide more details?", timestamp: "Yesterday" },
    ],
    ...
    try {
      ...
      if (selectedContact === "0xIdeaBot") {
        ...
        setTimeout(() => {
          ...
          // 处理任务推荐请求
          if (lowerMsg.includes("recommend") || lowerMsg.includes("suggest") || lowerMsg.includes("find tasks") || 
              lowerMsg.includes("show me tasks") || lowerMsg.includes("what tasks")) {
                ...
                setTimeout(() => {
                  const analysisCall: BotMessage = {
                    ...
                    toolCalls: [{
                      ...
                      input: "Analyze skill match for user with frontend development, UI design, data visualization skills",
                      status: "running", 
                      startTime: "Just now"
                    }]
                  };
                  ...
                  setTimeout(() => {
                    ...
                    setTimeout(() => {
                      const taskRecommendation: BotMessage = {
                        sender: "0xIdeaBot",
                        text: "Based on my analysis, here are the top 3 tasks that best match your skills:\n\n" +
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                setPublishedTaskData({
                  ...
                  description: "Design and develop an interactive dashboard for monitoring and analyzing yield farming opportunities across multiple DeFi protocols.",
                  reward: 350,
                  deadline: "10 days",
                ...
                setTimeout(() => {
                  const finalResponse: BotMessage = {
                    sender: "0xIdeaBot",
                    text: "You have successfully accepted the task \"DeFi Yield Farming Dashboard\"!\n\n" +
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                setTimeout(() => {
                  const finalResponse: BotMessage = {
                    sender: "0xIdeaBot",
                    text: "Your task \"Interactive DeFi Data Visualization Dashboard\" has been successfully published to the marketplace!\n\n" +
                          "Reward: 280 IDEA\n" +
                          "Deadline: 7 days\n" +
            ...
            setTimeout(() => {
              ...
              setTimeout(() => {
                ...
                setTimeout(() => {
                  const finalResponse: BotMessage = {
                    sender: "0xIdeaBot",
                    text: "You have successfully accepted the task \"" + (publishedTaskData?.title || "Interactive DeFi Data Visualization Dashboard") + "\"!\n\n" +
                          "Reward upon completion: " + (publishedTaskData?.reward || 280) + " IDEA\n" +
                          "Deadline: " + (publishedTaskData?.deadline || "7 days") + "\n\n" +
                          "Good luck with your work! You can submit your completed task through the task details page or by messaging me once you're done.",
                    timestamp: "Just now"
                  };
          ...
          // 根据消息内容确定使用哪些工具
          else if (lowerMsg.includes("create task") || lowerMsg.includes("generate task") || lowerMsg.includes("new task") || 
              lowerMsg.includes("data visualization") || lowerMsg.includes("defi")) {
          ...
          // 上链交互流程
          else if (lowerMsg.includes("transaction") || lowerMsg.includes("contract") || lowerMsg.includes("blockchain")) {
            setTimeout(() => {
          ...
          // 研究和分析流程
          else if (lowerMsg.includes("research") || lowerMsg.includes("analyze") || lowerMsg.includes("trends") || 
                   lowerMsg.includes("study") || lowerMsg.includes("information")) {
            setTimeout(() => {
              const researchCall: BotMessage = {
                sender: "0xIdeaBot",
            ...
            <div className="relative p-4 backdrop-blur-sm rounded-xl">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {publishedTaskData.skills.map((skill, idx) => (
                  <span key={idx} className="px-2 py-1 bg-indigo-900/60 text-indigo-300 text-xs rounded-md border border-indigo-500/30">
                    {skill}
                  </span>
                ))}
              </div>
                      ...
                      <div className={`max-w-[75%] relative group`}>
                        ...
                        <div className={`p-3 rounded-2xl ${
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center">
                                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${
                                        toolCall.status === "running" ? "bg-yellow-600/30 text-yellow-300" :
                                        toolCall.status === "completed" ? "bg-green-600/30 text-green-300" :
                                        "bg-red-600/30 text-red-300"
                                      }`}>
                                        {toolCall.status === "running" && (
                                          <svg className="animate-spin -ml-0.5 mr-1.5 h-2 w-2 text-yellow-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                          ...
                          <div className={`text-xs mt-1 ${
                            ...
                            {msg.sender === "me" && (
                              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-indigo-200/70 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                              </svg>
                            )}
                          </div>
