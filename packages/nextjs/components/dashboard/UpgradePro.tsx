            ...
            <div className="relative p-6 z-10 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-blue-200">≈ ${plans[selectedPlan].priceUSD} / {plans[selectedPlan].period}</div>
                </div>
              </div>
          ...
          {[
            {
              ...
              answer: "Your subscription will automatically renew using EIP-7702's auto-deduction feature. This means you won't have to manually approve transactions for each renewal period."
            },
            {
              question: "Can I upgrade or downgrade my plan?",
              answer: "Yes, you can upgrade to annual at any time. If you switch from annual to monthly, the change will take effect at the end of your current billing period."
            },
            {
              question: "How do I cancel my subscription?",
              answer: "You can cancel anytime from your account settings. After cancellation, you'll continue to have access to Pro features until the end of your current billing period."
            }
          ].map((faq, index) => (
