            ...
            <div className="w-full max-w-md mx-auto">
              <div className="relative">
                ...
                <div className="absolute left-3 top-1/2 -translate-y-1/2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-300 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredTasks.length === 0 ? (
            <div className="py-12 text-center col-span-full bg-base-200/10 backdrop-blur-sm rounded-2xl border border-purple-900/20">
              <div className="p-8">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-purple-300/50 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M12 20a8 8 0 110-16 8 8 0 010 16z" />
                </svg>
                  ...
                  <div className="relative card-body p-6 z-10">
                    ...
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <div className="flex items-center gap-1 ml-2 flex-shrink-0">
                        <span className={`badge badge-sm text-xs font-medium ${task.status === 'Active' ? 'bg-green-500/40 text-green-100' : 'bg-blue-500/40 text-blue-100'} border-0 px-2 py-2 backdrop-blur-sm`}>
                          {task.status}
                        </span>
                    ...
                    <div className="h-[36px] flex flex-wrap gap-1.5 mb-3 overflow-hidden">
                      {task.skills.map((skill, index) => (
                        <span key={index} className="badge badge-sm bg-purple-600/30 text-purple-100 hover:bg-purple-500/40 transition-colors border-0 text-xs py-1 backdrop-blur-sm">
                          {skill}
                        </span>
                      ))}
